...
نوشته شده با Telethon - مناسب برای Render.com
"""
...
WHITELIST = [777000, SUPPORT_BOT_ID]  # سرویس‌های تلگرام + ربات پشتیبانی

# اضافه کردن آیدی‌های اضافی از environment variables
if WHITELIST_IDS:
